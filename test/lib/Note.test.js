...
describe('Note', function () {
  ...
  describe('fromRaw(raw)', function () {
    var tests = [
      ...
      [['1.2.04', '1W', { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 10 }],
      [['1.2.04', '1W', 45, { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 45 }],
      [['1.2.04', '1W', null, 50, { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 10, 'volume': 50 }],
      [['1.2.04', '1W', null, 50, -50, { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 10, 'volume': 50, 'pitch': -50 }],
      [['1.2.04', '1W', null, 50, -50, -25, { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 10, 'volume': 50, 'pitch': -50, 'pan': -25 }],
      [['1.2.04', '1W', null, 50, -50, -25, 20, { 'duration': 10 }], { 'position': '1.2.04', 'target': '1W', 'duration': 10, 'volume': 50, 'pitch': -50, 'pan': -25 }]
    ];
