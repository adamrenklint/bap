...
[Bap](http://bapjs.org) is a Javascript library for making beats and composing music for browsers with Web Audio. It is heavily inspired by the classic "MPC workflow", has an internal clock based on 96 ticks per beat and is built to make all aspects of beatmaking extremely modular and reusable.
